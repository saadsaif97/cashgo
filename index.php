...
<body>
    <section class="text-left" id="hero" style="display: block;background-image: linear-gradient(to bottom, rgb(29 36 127 / 50%) 0%, rgba(20,18,19,0.6) 90%, #141213 100% ), url(assets/img/<?php echo $heroImg; ?>);filter: blur(0px) brightness(100%);width: 100%;height: 500px; background-size:cover;">
        <!--including top nav-->
        ...
        <div class="container">
            ...
            <h1 class="text-center big" data-aos="fade" data-aos-delay="200" style="color: rgb(255,255,255);font-family: Montserrat, sans-serif;"><br><strong><?php echo $tagLine; ?></strong><br><br></h1>
        </div>
    ...
    url(&quot;assets/img/features.jpg&quot;);
     ">
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-6 pt-5"></div>
    ...
    <section id="news">
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-12 col-md-8 col-lg-6" data-aos="fade">
                    <div class="text-center">
                        <p class="small-dark" data-aos="fade" data-aos-delay="100" style="margin-bottom: 0px; padding-bottom:5px;">LATEST<br></p>
                        ...
                        <a href="blog-grid.php" class="btn btn-primary" data-aos="fade" data-aos-delay="400" type="button" style="padding: 12px 50px;background-color: #d9d9d9; color:#333; font-weight:bolder; border:none; margin: 20px 0;">Blog</a>
                    </div>
                </div>
            </div>
            <!--
                ...
                ?>
                    ...
                    <div data-aos="fade" data-aos-delay="600">
                        ...
                        <div class="border2" style="padding: 20px 15px;">
                            ...
                            </div><a href="blog-post.php?id=<?php echo $id; ?>" style="color: #98b446;">Read More</a>
                        </div>
                    </div>
                <?php
                }
