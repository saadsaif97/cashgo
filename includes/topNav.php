    ...
    <div class="container d-flex align-items-center" style="font-size:13px; font-weight:bolder;">
        ...
        <div class="collapse navbar-collapse" id="navcol-1">
            ...
            <ul class="nav navbar-nav ml-auto" id="navbar-hover">
                <li class="nav-item" role="presentation"><a class="nav-link <?php if ($currentPage == "home") {
                                                                                echo 'active';
                                                                            } ?>" href="index.php">HOME</a></li>
                <li class="nav-item" role="presentation"><a class="nav-link <?php if ($currentPage == "howItWorks") {
                                                                                echo 'active';
                                                                            } ?>" href="how-it-works.php">HOW IT WORKS</a></li>
                <li class="nav-item" role="presentation"><a class="nav-link <?php if ($currentPage == "profit") {
                                                                                echo 'active';
                                                                            } ?>" href="profit.php">PROFIT</a></li>
                <li class="nav-item" role="presentation"><a class="nav-link <?php if ($currentPage == "plans") {
                                                                                echo 'active';
                                                                            } ?>" href="plans.php">PLANS</a></li>
                <li class="nav-item" role="presentation"><a class="nav-link <?php if ($currentPage == "blog") {
                                                                                echo 'active';
                                                                            } ?>" href="blog-grid.php">BLOG</a></li>
                <li class="nav-item" role="presentation"><a class="nav-link <?php if ($currentPage == "contact") {
                                                                                echo 'active';
                ...
                <?php else : ?>
                    <li class="nav-item" role="presentation"><a class="nav-link <?php if ($currentPage == "register") {
                                                                                    echo 'active';
                                                                                } ?>" href="register.php">REGISTER</a></li>
                    <li class="nav-item" role="presentation"><a class="nav-link <?php if ($currentPage == "login") {
                                                                                    echo 'active';
